...
### sampleselector 
`sampleselector2.pyw` и `fast_cutter.py` — инструмент для отбора аудиосемплов (после сплиттера) / комплексной правки датасета (после этапа транскрибации). Требуемые зависимости указаны в начале кода.
