Обновленный русские словарь (PR висит на сайте проекта и не факт что будет принят) с добавленными йотированными фонемами. Необходимо для нормального обучения новых голосов.
