...
- Символ `+` перед гласной позволяет делать расстановку в ручном режиме. Оба пункта работают только при замене словаря и использование моделей, обученыx на нём. О процессе расскывал в этом [видео](https://www.youtube.com/watch?v=zpWIUzaNHfw). 
