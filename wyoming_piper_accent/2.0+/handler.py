...
# Используем новый, улучшенный разделитель предложений
...
_CORRECTION_WORDS: Set[str] = set([
    ...
    "головы", "голоса", "гоним", "горе", "города", "господа", "графа",
    "гроши", "груди", "дела", "дорог", "дороги", "дорогой", "другом",
    "духи", "душа", "души", "дыбы", "еду", "жаркое", "жару", "жила", "жучка",
    "заводи", "залом", "замок", "замки", "запах", "заросли", "засели",
    ...
    "нужды", "облака", "окна", "опера", "орган", "органов", "органом",
    ...
    "попадал", "пора", "поручи", "постели", "потом", "поту", "пошло",
    "привод", "пристав", "пристань", "пропасть", "простынь", "просыпался",
    "пряди", "пылу", "реки", "рога", "руки", "самого", "самой", "самому",
    "саду", "сахара", "сведение", "свечи", "связи", "сели", "село", "семьи",
    "сестры", "синее", "скачка", "слез", "слезу", "слова", "смычка",
    "содержим", "сорок", "сорока", "соска", "соски", "спешить", "спина",
    "стада", "стены", "стоишь", "стоит", "стону", "стороны", "стою",
    ...
    "целую", "цепи", "цвета", "чайку", "часу", "чека", "чудное", "широты",
])
