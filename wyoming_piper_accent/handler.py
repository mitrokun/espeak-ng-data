...
_CORRECTION_WORDS: Set[str] = {
    "атлас", "белки", "белок", "берегу", "большая", "боры", "броня",
    "бури", "ведение", "верхом", "вести", "ветряная", "веках", "вина",
    "виски", "войны", "ворона", "ворот", "ворота", "всем", "все",
    "выходить", "гвоздик", "глотка", "глоток", "глубины", "глубоко", "года",
    "головы", "гоним", "горе", "города", "господа", "готов", "графа",
    "гроши", "дела", "дорогой", "дорог", "духи", "душа", "души",
    "дыбы", "еду", "жаркое", "жару", "жила", "жучка", "заводи",
    "залом", "замок", "замки", "запах", "засели", "здорово", "земли",
    "зимы", "знаком", "избегать", "извести", "ирис", "катера", "кирка",
    "клещи", "клубы", "козлы", "колки", "коне", "корпуса", "краю",
    "кружка", "кружки", "крыла", "леса", "лесок", "лета", "лиса",
    "лука", "любим", "мало", "мела", "меньшинства", "места", "мести",
    "меха", "мою", "моя", "мудрено", "мука", "начала", "начало",
    "нем", "ноги", "нужды", "облака", "окна", "опера",
    "орган", "остро", "пайки", "парить", "паром", "пекло", "перед",
    "пили", "пирога", "пища", "плачу", "повара", "пола", "полки",
    "полу", "полы", "поля", "попадал", "пора", "поручи", "постели",
    "потом", "поту", "пошло", "привод", "пристав", "пристань", "пропасть",
    "простынь", "пряди", "пчелы", "пылу", "рога", "руки", "самого",
    "сведение", "связи", "села", "сели", "село", "синее", "скачка",
    "слез", "слезу", "слова", "смычка", "содержим", "сорок", "сорока",
    "спешить", "спина", "стада", "стекла", "стоишь", "стоит", "стою",
